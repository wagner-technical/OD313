...
const MyMapComponent = compose(
  withProps({
    googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyBUTiUdo_iYTcYxzHqmnMIr1ixiRxujN1Q&v=3.exp&libraries=geometry,drawing,places",
  ...
  <GoogleMap
    defaultZoom={7}
    defaultCenter={{ lat: 43.151068, lng: -75.665420 }}
  >
    { props.poles.length &&
...
class MyFancyComponent extends React.PureComponent {
  ...
  render() {
    const activePoles = Object.keys(this.props.menu).reduce( (poles, townName) => {
